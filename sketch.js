...
function preload() {
  ...
  magicImg = loadImage('assets/magic.png')
...
//1100, 275
   ...
   hattie = new Ghost(1200, 500, hattie1, hattie2, hattie3, hattie4, hattie5, ["Hattie: Oh! Hello darlin'! I'm Hattie, but everyone just calls me Aunt Hattie. Are you settling in okay honey?", "You: Um... Kind of?", "Hattie: Oh goodness me! Your house isn't quite done yet is it? Here, take this hon.", "Hattie: Hopefully this helps you get on your feet sugar."])
       ...
       benjamin = new Ghost(1100, 725, benjamin1, benjamin2, benjamin3, benjamin4, benjamin5, ["Benjamin: Who are YOU. My names Benjamin. This is my toy car. I make toys and give them away to all my friends here. Especially Aunt Hattie. She’s not really my aunt.", "Benjamin: Is that your house over there? It looks boring. Did you know every day is my birthday here? That's what Aunt Hattie says because I died on my birthday.", "Benjamin: If you dont want your house can I have it? If not, use my magic powers to put a sign up! Or else it's mine for the taking!", "...Okay, it was nice meeting you kid"])
  
  
     louise = new Ghost(400, 725, louise1, louise2, louise3, louise4, louise5, ["Louise: Ah, mon ami. My name iz Louise. I cook and make drinks for ze people of zis town here in my cafe. But first I will help you.", "You: Oh, thank you!", "Louise: C’est la vie."])

  
     thorn = new Ghost(300, 500, thorn1, thorn2, thorn3, thorn4, thorn5, ["Thorn: Oh great, another one. Welcome to Hell. I'm Thorn by the way.", "Nice to meet you.", "Thorn: Yeah, yeah. I'll help you out with your house, but just this one time."])
  

  
     sage = new Ghost(400, 275, sage1, sage2, sage3, sage4, sage5, ["Sage: Oh... hi there. I'm Sage. I don't really come out of my library very often, but I'm glad I did today to meet you!", "You: Nice to meet you too!", "Sage: Oh... uh... cool house you got there. It looks like it needs something though, here. Take this to it.", "Sage: See you later!"])
  ...
  //set up houses
    ...
    magic1 = new AstralMagic(750, 530, magicImg)
    magic2 = new AstralMagic(1200, 425, magicImg)
    magic3 = new AstralMagic(1100, 670, magicImg)
    magic4 = new AstralMagic(280, 430, magicImg)
    magic5 = new AstralMagic(380, 210, magicImg)
    magic6 = new AstralMagic(380, 650, magicImg)
...
function draw() {
 ...
 if (player.collides(wesley.sprite)) {
       magic1.sprite.collider = "dynamic"
  ...
  if (wallsPresent === true && windowsPresent === true && signPresent === true && doorPresent === true && roofPresent === true && foilagePresent === true) {
    ...
    dialogue = ["Wesley: Well you done it partner. You got yourself a nice place. You’ll start feeling that Astral Magic soon that you can use at your own will. Until then, just enjoy yourself. It’s peaceful here. You can make your afterlife exactly how you want it to be. We’ll be here if you need us. We can talk, share stories, whatever you like. Just rest for now though. I’ll see you later.", "You: It’s nice here.", "THE END"]
       talking = true 
